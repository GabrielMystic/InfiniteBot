...
let frep = { contextInfo: { externalAdReply: {title: wm, body: author, sourceUrl: redesMenu.getRandom(), thumbnail: await(await fetch(infiniteMenu.getRandom())).buffer() }}}
...
let list = (await axios.get(`https://raw.githubusercontent.com/GabrielMystic/InfiniteBot/master/src/JSON/frase2.json`)).data  
