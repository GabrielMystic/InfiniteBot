...
const smsLista1 = () => { return `♾️ INFORMACIÓN DE INFINITEBOT ♾️`}
...
const smsLista7 = () => { return `🪐 INSTALAR INFINITEBOT 🪐`}
...
const eOrionCoins = () => { return '♾️ OrionCoins' }
const eOrionTickets = () => { return '🎫 Orion Tickets' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar InfiniteBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar InfiniteBot en Grupos`}
...
smsSetB, smsSetB2, smsSetW, smsSetW2, smsDest, smsNam1, smsNam2, smsNam3, smsRestGp, smsSig, smsSigPrem, 
...
smsJBCerrarS, smsJBErr, smsList1, smsList2, smsList3, smsList4, smsList5, smsList6, smsConj, smsFras };
